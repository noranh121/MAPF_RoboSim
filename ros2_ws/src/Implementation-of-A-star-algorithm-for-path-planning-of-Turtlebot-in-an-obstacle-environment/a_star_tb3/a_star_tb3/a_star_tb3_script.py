...
def main():
    ...
    velo2 = astar.a_star(args.goal_x, args.goal_y,
                      -0.25, 0.6, args.RPM1, args.RPM2, args.clearance)
...
# ,(0.02953133168998523, 0.09937756105581574, 0.43196898986859655)]
    rclpy.init()
    move_turtlebot = ROS_move(velo,"robot2")
    move_turtlebot2 = ROS_move(velo2,"robot1")
