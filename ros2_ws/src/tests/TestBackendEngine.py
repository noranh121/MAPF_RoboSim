    ...
    def test_get_benchmark_path(self):
        ...
        try:
            with unittest.mock.patch('os.getcwd') as mock_getcwd:
                ...
                expected_path = '/home/ali/MAPF_RoboSim/ros2_ws/src/mapf_simulator/backend/benchmarks/test.txt'
                ...
                expected_path = '/home/ali/MAPF_RoboSim/ros2_ws/src/mapf_simulator/backend/benchmarks/complex-name_123.txt'
                result = self.engine.get_benchmark_path(benchmark_file)
